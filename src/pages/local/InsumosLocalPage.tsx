  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Button onClick={() => { setEditingInsumo(null); setModalOpen(true); }}>
                  ...
                  <TableCell>
                    {!isObligatorio && (
                      <div className="flex gap-1 justify-end">
                        <Button variant="ghost" size="icon" onClick={() => { setEditingInsumo(row); setModalOpen(true); }}><Pencil className="w-4 h-4" /></Button>
      ...
      <InsumoFormModal
        open={modalOpen}
        onOpenChange={(open) => { setModalOpen(open); if (!open) setEditingInsumo(null); }}
      ...
      <ConfirmDialog
        ...
        variant="destructive"
        onConfirm={async () => { if (deletingInsumo) await deleteInsumo.mutateAsync(deletingInsumo.id); setDeletingInsumo(null); }}
      />
    </div>
  );
}
