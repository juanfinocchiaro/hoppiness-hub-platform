...
export default function ConceptosServicioPage() {
  ...
  return (
    <div className="p-6">
              ...
              <TableRow key={row.id} className={row.visible_local === false ? 'opacity-50' : ''}>
                ...
                <TableCell>
                  <div className="flex gap-1">
                    ...
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive" onClick={() => softDelete.mutate(row.id)}>
      ...
      <ConceptoServicioFormModal open={!!editing} onOpenChange={() => setEditing(null)} concepto={editing} />
    </div>
  );
}
