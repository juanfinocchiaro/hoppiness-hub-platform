...
import { Percent, AlertTriangle, CheckCircle, TrendingDown, Edit, History } from 'lucide-react';
              ...
              <TableRow key={p.menu_producto_id}>
                ...
                <TableCell>
                  <div className="flex items-center gap-1">
                    <Button variant="outline" size="sm" onClick={() => { setPrecioModal(p); setNuevoPrecio(p.precio_sugerido || p.precio_base); }}>
