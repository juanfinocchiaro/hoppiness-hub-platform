    ...
    return (
      ...
      >
        ...
        <div style={{
          ...
          <span><strong>Reglamento:</strong> {data.regulationTitle}</span>
          <span><strong>Versión:</strong> {data.regulationVersion}</span>
          <span><strong>Publicado:</strong> {publishedFormatted}</span>
          <span><strong>Sucursal:</strong> {data.branchName}</span>
        </div>
        ...
        <div style={{ marginBottom: '16px', textAlign: 'justify', fontSize: '10pt' }}>
          ...
          <ol style={{ marginLeft: '12px', paddingLeft: '8px', marginTop: 0, marginBottom: 0 }}>
            ...
            <li style={{ marginBottom: '4px' }}>
              Que he leído íntegramente su contenido y comprendo todas las disposiciones allí establecidas.
            </li>
            <li style={{ marginBottom: '4px' }}>
              Que me comprometo a cumplir con todas las normas, políticas y procedimientos 
              detallados en dicho reglamento durante la vigencia de mi relación laboral con la empresa.
            </li>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '9pt', color: '#666', marginTop: '2px', marginBottom: 0 }}>(Testigo)</p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{ marginTop: '2px', marginBottom: 0 }}>
            © {new Date().getFullYear()} Hoppiness Club - Documento interno | 
            Este documento debe ser firmado en dos ejemplares.
          </p>
        </div>
      </div>
    );
