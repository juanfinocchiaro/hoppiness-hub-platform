              ...
              <DialogContent>
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">App de restaurante → Historial del turno</p>
                  </div>
                  <div>
                    <strong>Rappi:</strong>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">MercadoPago → Actividad → Filtrar delivery</p>
                  </div>
                  <div className="bg-muted p-3 rounded-lg">
                    <p className="font-medium">Formas de pago en Núcleo</p>
                    <ul className="text-muted-foreground mt-1 space-y-1">
                      <li>• Rappi, PeYa, MP Delivery no integrados → <strong>Vales</strong></li>
                      <li>• PeYa efectivo → <strong>Efectivo</strong> (va a caja del local)</li>
                    </ul>
                  </div>
                </div>
              </DialogContent>
            ...
            <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t">
                    ...
                    <div className="flex-1">
                      <Input
                        ...
                        onChange={(e) => handleChange('mas_delivery', 'total_panel', parseNumber(e))}
              ...
              {isAppEnabled('rappi') && (
                <div className="p-4 rounded-lg border bg-card">
                  ...
                  <div className="mb-3">
                    <Label className="text-xs text-muted-foreground">Vales (Núcleo) - Todo digital</Label>
                    <Input
                      type="number"
                      min={0}
                      step={0.01}
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t">
                    <span className="text-xs text-muted-foreground">Núcleo: {formatCurrency(getNucleoSum('rappi'))}</span>
                    <span className="text-muted-foreground">→</span>
                    <div className="flex-1">
                      <Input
                        type="number"
              ...
              {isAppEnabled('pedidosya') && (
                <div className="p-4 rounded-lg border bg-card">
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t">
                    <span className="text-xs text-muted-foreground">Núcleo: {formatCurrency(getNucleoSum('pedidosya'))}</span>
                    <span className="text-muted-foreground">→</span>
                    <div className="flex-1">
                      <Input
                        type="number"
              ...
              {isAppEnabled('mp_delivery') && (
                <div className="p-4 rounded-lg border bg-card">
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t">
                    <span className="text-xs text-muted-foreground">Núcleo: {formatCurrency(getNucleoSum('mp_delivery'))}</span>
                    <span className="text-muted-foreground">→</span>
                    <div className="flex-1">
                      <Input
                        type="number"
