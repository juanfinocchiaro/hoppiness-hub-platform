...
const timeline = [
  { year: '2018', text: 'Nace Hoppiness como club de cervezas en Cofico, un pequeño barrio de Córdoba.', highlight: false },
  { year: '2019', text: 'Abrimos en Nueva Córdoba. La gente empieza a pedirnos hamburguesas.', highlight: false },
  { year: '2020', text: 'Pivoteamos. Apostamos 100% a las hamburguesas. De 40 a 600 por día.', highlight: false },
        ...
        <div className="relative">
          ...
          <div className="space-y-8">
            {timeline.map((item, i) => (
              ...
              >
                {/* Year bubble */}
                <div className={`absolute left-6 md:left-1/2 transform -translate-x-1/2 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center z-10 ${item.highlight ? 'bg-accent text-accent-foreground' : 'bg-primary text-primary-foreground'}`}>
                  {item.highlight ? (
                ...
                {/* Content */}
                <div className={`ml-20 md:ml-0 md:w-[calc(50%-4rem)] ${i % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8 md:text-left'}`}>
