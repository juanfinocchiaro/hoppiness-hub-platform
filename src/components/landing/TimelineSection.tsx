        ...
        <div className="relative">
          ...
          <div className="space-y-8">
            {timeline.map((item, i) => (
              ...
              >
                {/* Year bubble */}
                <div className={`absolute left-8 md:left-1/2 transform -translate-x-1/2 w-16 h-16 rounded-full flex items-center justify-center z-10 ${item.highlight ? 'bg-accent text-accent-foreground' : 'bg-primary text-primary-foreground'}`}>
                  {item.highlight ? (
                ...
                {/* Content */}
                <div className={`ml-28 md:ml-0 md:w-[calc(50%-4rem)] ${i % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8 md:text-left'}`}>
