...
export function ManagerCompetencyRow({ competency, score, onScoreChange }: ManagerCompetencyRowProps) {
  return (
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          {competency.description && (
            <p className="text-xs text-muted-foreground truncate hidden sm:block">{competency.description}</p>
          )}
        </div>
