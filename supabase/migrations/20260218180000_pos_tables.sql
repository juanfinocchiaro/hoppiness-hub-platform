-- =============================================
-- POS - Tablas principales: pedidos, pagos, turnos_caja, pos_config
-- =============================================
...
CREATE UNIQUE INDEX idx_pedidos_numero_dia ON pedidos (branch_id, numero_pedido, ((created_at AT TIME ZONE 'UTC')::date));
CREATE INDEX idx_pedidos_branch_estado ON pedidos(branch_id, estado);
CREATE INDEX idx_pedidos_branch_fecha ON pedidos(branch_id, created_at);
...
CREATE INDEX idx_turnos_caja_branch ON turnos_caja(branch_id);
CREATE INDEX idx_turnos_caja_estado ON turnos_caja(branch_id, estado) WHERE estado = 'abierto';
